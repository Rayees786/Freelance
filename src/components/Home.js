    ...
    <div className="width">
      ...
      <Navbar bg="light" variant="dark">
        <Navbar.Brand href="#home">
          <img alt="" src={logoclient1} width="10%" height="40px" />
          <img alt="" src={logoclient2} width="10%" height="40px" />
          <img alt="" src={logoclient3} width="10%" height="40px" />
          <img alt="" src={logoclient4} width="10%" height="40px" />
          <img alt="" src={logoclient5} width="10%" height="40px" />
          <img alt="" src={logoclient6} width="10%" height="40px" />
          <img alt="" src={logoclient3} width="10%" height="40px" />
          <img alt="" src={logoclient4} width="10%" height="40px" />
          <img alt="" src={logoclient1} width="10%" height="40px" />
          <img alt="" src={logoclient4} width="10%" height="40px" />
          ...
          <Col sm={6} className="Monde">
            <Card className="card1">
              ...
              <Card.ImgOverlay>
                ...
                <br />
                <Card.Body>
                  <Card.Title className="one">
                    {" "}
                    <p>
                      {" "}
                      <b>
                        42 million professionals <br /> on demand{" "}
                      </b>{" "}
                    </p>
                  </Card.Title>
                  <Card.Text>
                    Why hire people when you can <br /> simply integrate our
                    talented <br /> cloud workforce instead?
                  </Card.Text>
          ...
          <Col sm={6} className="Monde">
            <Card className="card2">
              ...
              <Card.ImgOverlay>
                ...
                <br />
                <Card.Body>
                  <Card.Title className="two">
                    <p>
                      {" "}
                      <b>
                        Company budget? Get <br /> more done for less{" "}
                      </b>{" "}
                    </p>
                  </Card.Title>
                  <Card.Text>
                    Use our workforce of 42 million to <br /> help your business
                    achieve more.
                  </Card.Text>
